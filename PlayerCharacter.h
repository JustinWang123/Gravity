...
public:
							PlayerCharacter(Uint32 setId, GameSim* setGameSim);
	...
	Vector2df				GetPos() const {return pos;}
	Uint32					GetHealth() const {return health;}
	Uint32					GetNumOfBullets() const {return numOfBullets;}
	Uint32					GetNumOfMissiles() const {return numOfMissiles;}
	Uint32					GetNumOfMines() const {return numOfMines;}
	Uint32					GetScore() const {return score;}
	bool					IsSolid(Vector2df atPos);
	bool					IsDead() const {return health == 0;}
	Uint32					GetKillerId() const {return killerId;}
	bool					GetRespawnMe() const {return respawnMe;}
...
protected:
	...
	bool					IsReadyToAttack() const {return attackDelay <= 0;}
