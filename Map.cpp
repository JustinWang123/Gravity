...
// ------------------------------------------------------------------------------------------------
Map :: Map(Vector2df setScreenPos, GameSim* setGameSim) {
	...
	for(Tile y = 0; y < MAP_NUM_TILES_Y; y++) {
		for(Tile x = 0; x < MAP_NUM_TILES_X; x++) {
			...
			if( (TileType)data < TILE_TYPE_BULLET_PICKUP) {
				...
				if((TileType)data == TILE_TYPE_BULLET_PICKUP) {
					gameSim->CreatePickUp(Vector2df(x * MAP_TILE_SIZE + MAP_TILE_SIZE / 2, y * MAP_TILE_SIZE + MAP_TILE_SIZE / 2), PICK_UP_TYPE_BULLETS);
				}
				else if((TileType)data == TILE_TYPE_MINE_PICKUP) {
					gameSim->CreatePickUp(Vector2df(x * MAP_TILE_SIZE + MAP_TILE_SIZE / 2, y * MAP_TILE_SIZE + MAP_TILE_SIZE / 2), PICK_UP_TYPE_MINES);
				}
				else if((TileType)data == TILE_TYPE_MISSILE_PICKUP) {
					gameSim->CreatePickUp(Vector2df(x * MAP_TILE_SIZE + MAP_TILE_SIZE / 2, y * MAP_TILE_SIZE + MAP_TILE_SIZE / 2), PICK_UP_TYPE_MISSILES);
				}
				else if((TileType)data == TILE_TYPE_REPAIR_PICKUP) {
					gameSim->CreatePickUp(Vector2df(x * MAP_TILE_SIZE + MAP_TILE_SIZE / 2, y * MAP_TILE_SIZE + MAP_TILE_SIZE / 2), PICK_UP_TYPE_REPAIR);
				}
